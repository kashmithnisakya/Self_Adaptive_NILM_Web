...
def get_predictions(): 
    ...
    # import data
    df = pd.read_csv(f'{current_directory}/data/{appliance_name}.csv')

    df_aggregate = df[df.columns[:3]]

    df_aged = df[df.columns[3:6]]
    ...
    three_ph_fridge_1_best_weights = f'{current_directory}/weights/3_phase_fridge_1_initial/3_phase_fridge_1_weights.40-0.03.hdf5'
    ...
    aging_model.load_weights(f'{current_directory}/weights/3_phase_fridge_1_year_3/0_1_2_3_working_base_model_0_1_2_weight.h5')
